...
#
# Generated by Vivado on Mon Dec 03 10:13:59 -0800 2018
...
# Script info
echo -e "clk_wiz_0.sh - Script generated by export_simulation (Vivado v2018.2.1 (64-bit)-id)\n"
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic" \
    "$ref_dir/../../../../Balkawade_Cetola_proj1.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0_clk_wiz.v" \
    "$ref_dir/../../../../Balkawade_Cetola_proj1.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0.v" \
  2>&1 | tee -a vlogan.log
