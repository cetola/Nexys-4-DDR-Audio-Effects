...
// GPIO (memory-mapped I/O: switches and LEDs from the FPGA board), 7-seg display and RGB LEDs.
...
// memory-mapped I/O
 ...
 //   output     [`MFP_N_RGB_CTRL - 1  :0] IO_RGB_CTRL  
);
  ...
  mfp_ahb_rgb  mfp_ahb_rgb(HCLK,HRESETn,HADDR,HTRANS,HWDATA, HWRITE, HSEL[4],
                             HRDATA4, IO_RGB_DATA);//IO_RGB_CTRL);
...
(
  ...
  assign HSEL[3] = (HADDR[28:22] == `H_7SEG_ADDR_MATCH);      // 7 Segment Display at 0xbF700000 (physical: 0x1F700000)
  assign HSEL[4] = (HADDR[28:22] == `H_RGB_ADDR_Match);       // RGB LEDs at 0xbF900000 
endmodule
